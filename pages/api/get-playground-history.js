...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!userData.requests || !userData.requests.playground_analysis || !userData.requests.playground_analysis.log) {
    ...
    const formattedHistory = playgroundHistory.map((item, index) => {
      ...
      return {
        ...
        details: {
          analysisType: item.parameters.analysisType || "getplaygroundgeneralanalysis",
